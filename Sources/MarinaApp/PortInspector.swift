...
/// Finds who is listening on a port. Marina never kills anything on its own:
...
enum PortInspector {
    ...
    enum StopError: LocalizedError {
        ...
        var errorDescription: String? {
            ...
            case .listenerChanged: return "The listener changed before Marina could stop it. Refresh and try again."
