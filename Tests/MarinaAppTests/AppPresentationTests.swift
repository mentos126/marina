...
final class AppPresentationTests: XCTestCase {
    ...
    func testLoadReadsExplicitFalseDock() {
        let defaults = isolatedDefaults()
        defaults.set(false, forKey: MarinaPreferences.showInDockKey)
        defaults.set(true, forKey: MarinaPreferences.showMenuBarItemKey)
    ...
    func testLoadRepairsBothEntryPointsHidden() {
        let defaults = isolatedDefaults()
        defaults.set(false, forKey: MarinaPreferences.showInDockKey)
        defaults.set(false, forKey: MarinaPreferences.showMenuBarItemKey)
    ...
    private func isolatedDefaults() -> UserDefaults {
        let name = "marina.tests.presentation.\(UUID().uuidString)"
